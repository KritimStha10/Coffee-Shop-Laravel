        ...
        <div class="row">
            <div class="col-12 col-sm-12">
                <div class="card card-primary card-outline card-tabs">
                    ...
                    <form id="EditForm" action="{{ route('admin.testimonial.update', $testimonial->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="tab-content" id="custom-tabs-three-tabContent">
                                <div class="tab-pane fade show active" id="custom-tabs-three-general" role="tabpanel" aria-labelledby="custom-tabs-three-general-tab">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id="summernote" name="description">{!! $testimonial->description !!} </textarea>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <img src="{{ asset('uploads/testimonials/'.$testimonial->image) }}" height="80" width="100">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control m-bot15" name="status">
                                            <option value="1" {{ ($testimonial->status == 1) ? 'selected="selected"' : '' }}>Active</option>
                                            <option value="0" {{ ($testimonial->status == 0) ? 'selected="selected"' : '' }}>Deactive</option>
                                        </select>
                                    </div>
