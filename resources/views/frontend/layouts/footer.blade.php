<footer class="footer">
            ...
            <div class="row">
              <div class="col-sm-6 col-lg-3">
                <div class="widget widget-about">
                  <img
                    src="assets/images/about/logoo - Edited.png"
                    class="footer-logo"
                    alt="Footer Logo"
                    width="105"
                    height="25"
              ...
              <div class="col-sm-6 col-lg-3">
                <div class="widget">
                  ...
                  <ul class="widget-list">
                    <li><a href="about.html">About Coffee Beans</a></li>
                    <li><a href="#">FAQ</a></li>
        ...
        <div class="footer-bottom">
          <div class="container">
            <p class="footer-copyright">
              Copyright © 2019 Coffee Beans Store. All Rights Reserved.
            </p>
      ...
      <div class="mobile-menu-wrapper">
        ...
        <nav class="mobile-nav">
          <ul class="mobile-menu">
            ...
            <li>
              <a href="booking.html" class="sf-with-ul">Booking</a>
            </li>
            <li>
    ...
    <script src="{{ asset('frontend/assets/js/bootstrap-input-spinner.js') }}"></script>
     <script src="{{ asset('frontend/assets/js/jquery.elevateZoom.min.js') }}s"></script>
